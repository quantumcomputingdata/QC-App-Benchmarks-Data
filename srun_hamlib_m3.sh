...
#appargs=(-a cudaq -c 2 -s 1000 -min $MIN -max $MAX -k 2 -m 3 -ham condensedmatter/tfim/tfim -params 1D-grid:pbc,_h:2)
appargs=(-a cudaq -c 2 -s 1000 -min $MIN -max $MAX -k 1 -m 3 -steps 10)
