...
echo srun -n $1 python -m mpi4py -m qedcbench.hamlib.hamlib_simulation_benchmark "${appargs[@]}" 

srun -n $1 python -m mpi4py -m qedcbench.hamlib.hamlib_simulation_benchmark "${appargs[@]}" 2>&1 | tee hamlib.log
