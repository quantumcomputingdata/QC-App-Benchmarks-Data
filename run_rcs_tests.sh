...
#SBATCH --mail-user=tlubinski1@gmail.com
...
############################
# Run the RCS benchmark programs

srun -n $TOTAL_GPUS python rcs.py 33 30 10  2>&1 | tee qpe_64_33.log

srun -n $TOTAL_GPUS python rcs.py 39 30 10  2>&1 | tee qpe_64_39.log
